Crafty.c('TrackFullTarget', {
    init: function() {
        this.requires("2D");
        this.requires("Canvas");
        this.requires("target1completed");
    ...
    onHitCustom: function(track) {
        ...
        Settings.scope += 50;
        Crafty.e("TrackFullTargetCompleted").attr({x: this.x, y: this.y, w: this.w, h: this.h});
        this.clean();
        track.clean();
        Game.win()
    },
    ...
    clean: function() {
        this.removeComponent('TrackFullTarget');
        this.destroy();
    }
});